...
class Recommender extends Idea
{
    ...
    public string $intro = 'Vyrábame množstvo kombinácii strihov a farieb a ťažko sa to v katalógu prehľadáva. ' .
    'Odporúčač bude lepšie ponúkať vhodné produkty k práve zobrazenému.';
